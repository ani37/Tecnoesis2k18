...
public class CustomRobotronAdapter extends PagerAdapter {
    private Context mCtx;
    private TextView tvContactHeader, tvDesc, tvPstat, tvRegister, tvPdf, tvContact1, tvContact2,tvContact3, tvm1header, tvm1desc, tvm2header, tvm2desc, tvHeader, tvPrize, tvHeaderPstat;
    private List<ModuleEvent> list;

    public CustomRobotronAdapter(Context mCtx, List<ModuleEvent> list) {
        this.mCtx = mCtx;
        this.list = list;
    }
